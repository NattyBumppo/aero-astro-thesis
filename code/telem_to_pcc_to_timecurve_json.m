...
for averaged_matrix_col_num = 1:floor(timestep_count/5),
    full_matrix_start_col_num = (averaged_matrix_col_num - 1)*5 + 1;
    full_matrix_stop_col_num = (averaged_matrix_col_num - 1)*5 + 5;
    
    pcc_corr_over_time_simpler(:, averaged_matrix_col_num) = mean(pcc_corr_over_time(:, full_matrix_start_col_num:full_matrix_stop_col_num), 2);
    tau_corr_over_time_simpler(:, averaged_matrix_col_num) = mean(tau_corr_over_time(:, full_matrix_start_col_num:full_matrix_stop_col_num), 2);
    rho_corr_over_time_simpler(:, averaged_matrix_col_num) = mean(rho_corr_over_time(:, full_matrix_start_col_num:full_matrix_stop_col_num), 2);
end
...
% These simplified distance matrices will be used to generate .csv files,
% which we'll load in Python and use to generate our file .csv files.
pcc_distance_matrix_file_simpler = 'pcc_distance_matrix_averaged.csv';
tau_distance_matrix_file_simpler = 'tau_distance_matrix_averaged.csv';
rho_distance_matrix_file_simpler = 'rho_distance_matrix_averaged.csv';
